# Practica 2 Arturo Buganza
Second practice of the microcontroller laboratory.
## Objectives
...
Ordering the plate components to fit was very hard, also imagine that the size of the slicon plate adds expenses, so good designers should always go for thighter and smaller designs.

If i wasnt following the final product step showed in the practice it would be very hard for me to get this done, since you have no clue where to start. Probably with some practice this can get done easier.

I learnt to always save progress. This long and tedious design showed me lots of things, but the most important information i obtained is that designs continue improving constantly, me myself while doing this, continiously went back to correct myself after being done. 

I tried not to cross any cables but I wonder if its posible to do so, maybe using different layers on te plate.
